...
exports.ErrorSeverity = exports.validateApiKey = void 0;
...
Object.defineProperty(exports, "validateApiKey", { enumerable: true, get: function () { return secretManager_1.validateApiKey; } });
/**
...
(function (ErrorSeverity) {
    ...
    ErrorSeverity["CRITICAL"] = "critical"; // 서비스 중단 수준
...
function classifyError(error, context) {
    ...
    // 기본 분류
    return { severity: ErrorSeverity.MEDIUM, category: 'unknown', message, retryable: isTemporaryError(error), context };
}
/**
 * 분류된 에러를 Firestore에 로깅합니다.
 * 심각도가 HIGH 이상인 경우에만 저장합니다.
 */
async function logError(classified) {
