...
export const INITIAL_GLOBAL_SOURCES: Omit<GlobalSource, 'id' | 'createdAt' | 'updatedAt' | 'createdBy' | 'lastTestedAt' | 'lastTestResult'>[] = [
  ...
  {
    name: '매일경제',
    description: '경제 섹션별. M&A 관련 기사 다수. RSS 미제공.',
    url: 'https://www.mk.co.kr',
    type: 'scraping',
    language: 'ko',
    relevanceScore: 4,
    category: 'domestic',
    listSelector: '.article-item, .news-item',
    titleSelector: 'h2 a, h3 a, .article-title a',
    linkSelector: 'a[href*="/news/"]',
    dateSelector: '.article-date, .date',
    defaultKeywords: EXTENDED_KO_KEYWORDS,
    status: 'inactive',
    pricingTier: 'free',
    notes: 'RSS 미제공 - scraping 필요. 셀렉터 검증 필요',
  },
  {
    name: '파이낸셜뉴스',
  ...
  {
    name: '서울경제',
    description: '머니타워 M&A 섹션. RSS 미제공.',
